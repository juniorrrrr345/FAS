  ...
  return (
    <div className="fixed inset-0 bg-black z-[10000] overflow-hidden">
      ...
      <div className="p-3 sm:p-4 lg:p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          {product.description && (
            <div className="mt-4 p-4 bg-black/30 border border-white/10 rounded-xl">
              <h3 className="text-white font-bold mb-2 flex items-center text-responsive-base">
                <span className="mr-2">📝</span>
                Description
              </h3>
              <p className="text-gray-300 text-responsive-sm leading-relaxed whitespace-pre-wrap">
                {product.description}
              </p>
            </div>
          )}
        ...
        {/* Bouton WhatsApp - responsive avec espace pour éviter le chevauchement */}
        <div className="mb-4">
          <a
            href={whatsappLink}
            target="_blank"
