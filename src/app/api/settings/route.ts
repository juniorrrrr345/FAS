  ...
  try {
    ...
    if (!settings) {
      ...
      const defaultSettings = {
        shopTitle: 'FAS Boutique',
        shopSubtitle: 'Votre boutique en ligne',
        scrollingText: 'FAS BOUTIQUE 📲 • LIVRAISON RAPIDE • QUALITÉ GARANTIE • ',
        loadingText: '',
        bannerText: '🔥 Bienvenue chez FAS Boutique 🔥',
        backgroundImage: '',
